...
%
%   J = VARHIST(I) Performs CLAHE on the intensity image I.
%
%   J = VARHIST(I,PARAM1,VAL1,PARAM2,VAL2...) sets various parameters.
...
%
%   - VARHIST can use Uniform, Rayleigh, or Exponential distribution as
...
%
%      I = imread('tire.tif');
%      A = varhist(I,'clipLimit',0.02,'Distribution','rayleigh');
%      figure, imshow(I);
%      figure, imshow(A);
%
%   Example 2
...
%      LAB(:,:,1) = varhist(L,'NumTiles',[8 8],'ClipLimit',0.005)*100;
